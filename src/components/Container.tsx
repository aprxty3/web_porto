...
export default function Container(props: ContainerProps) {
    ...
    const meta = {
        title: "Aprxty",
        description: `Mobile Dev Engineer with FLutter and Kotlin.`,
    ...
    return (
        <>
            <Head>
                ...
                <meta property="og:site_name" content="Aprxty"/>
                <meta property="og:description" content={meta.description}/>
                <meta property="og:title" content={meta.title}/>
                <meta property="og:image" content={meta.image}/>
                <meta name="twitter:card" content="summary_large_image"/>
                <meta name="twitter:site" content="Aprxty"/>
            ...
            >
                ...
                <Link href="/">
                    <span className="text-lg font-semibold">aprxty</span>
                </Link>
                ...
                <AnimatePresence key="menu">
                    {isOpen && (
                        ...
                        >
                            {/* Expandable menu */}
                            <div
                                className="flex h-20 max-h-20 min-h-[60px] w-full items-center justify-between border-b pl-[22px] pr-1">
                  ...
                  <span className="text-sm text-muted-foreground">
                    © {new Date().getFullYear()} aprxty. All rights reserved.
                  </span>
                                </div>
                            </div>
                        </motion.div>
